...
// Getters
float Materiau::getCoeffAmbiant ( void ) const
{
    return this->coeff_ambiant;
}
float Materiau::getCoeffDiffus ( void ) const
{
    return this->coeff_diffus;
}
float Materiau::getCoeffSpeculaire ( void ) const
{
    return this->coeff_speculaire;
}
int Materiau::getHardness ( void ) const
{
