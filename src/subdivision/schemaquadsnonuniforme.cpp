...
SchemaQuadsNonUniforme::SchemaQuadsNonUniforme() : Schema()
{
    // rien
}
QString SchemaQuadsNonUniforme::getTCS ( void ) const
{
    return "quads";
}
Mot SchemaQuadsNonUniforme::calculMot( unsigned int precision, double u, double v ) const
{
    Mot mot = Mot ( );
...
void SchemaQuadsNonUniforme::genererMatrices( unsigned int valence_min, unsigned int valence_max )
{
...
void SchemaQuadsNonUniforme::genererDictionnaire ( void )
{
...
void SchemaQuadsNonUniforme::calculCombinaison( unsigned int valence, Mot mot  )
{
    ...
    {
        this->liste_coeff.  push_back( M.getCoeff( 0, i ) ); // On pourrait s'en débarrasser avec des matrices 6x plus grandes ???
