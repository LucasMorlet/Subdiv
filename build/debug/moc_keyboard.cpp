...
#include <memory>
#include "../../src/controls/keyboard.h"
...
QT_MOC_LITERAL(9, 14), // "toggleLeftDock"
QT_MOC_LITERAL(24, 0), // ""
QT_MOC_LITERAL(25, 15), // "toggleRightDock"
QT_MOC_LITERAL(41, 7) // "quitApp"

    },
    "Keyboard\0toggleLeftDock\0\0toggleRightDock\0"
    "quitApp"
};
...
void Keyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Keyboard::toggleLeftDock)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Keyboard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Keyboard::toggleRightDock)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Keyboard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Keyboard::quitApp)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Keyboard::toggleLeftDock()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Keyboard::toggleRightDock()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Keyboard::quitApp()
{
